...
class Nav:
    ...
    def switch_to_home(self):
        view1 = HomeView(self)
        self._base_view.switch_view(view1, "Chess Manager - Home")

    def switch_to_tournament_creation(self):
        tournament_creation_view = TournamentCreationView(self)
        self._base_view.switch_view(tournament_creation_view, "Chess Manager - Trournament creation")
    ...
    def switch_to_tournament_read(self):
        ...
        self._base_view.switch_view(tournament_read_view, "Chess Manager - Trournament view")
