...
class RoundReadView(QWidget):
    ...
    def populate_table(self):
        for round in self.tournament.rounds:
            ...
            for match in round.matches:
                ...
                #     lambda index,
                #     combo_box=combo_box,
                #     match=match: self.handle_combo_box_change(
                #         index,
                #         combo_box,
                #         match
                #         )
    ...
    def save_changes(self,
        ...
        if combo_boxes_data:
            ...
            for combo_box_data in combo_boxes_data:
                ...
                usable_data.append(
                    combo_box_data.itemData(combo_index, Qt.UserRole)
                    )
            self.tournament_controller.manage_round_data(
                round, usable_data,
                round_name,
                round_start_date,
                self.has_start_date_changed,
                round_end_date,
                self.has_end_date_changed
                )

    # def handle_combo_box_change(self, index, combo_box, current_match):
    #     try:
    #         # matching_match = next(
    #         #     (match for round in self.tournament.rounds
    #         #      if any(match == match for match in round.matches)),
    #         #     None
    #         # )
    #         # round = next(
    ...
    #         if (
    #             selected_value == MatchResult.DRAW
    #             and self.previous_result == MatchResult.WIN
    #         ):
    #             player_one_edited_score = (
    #                 current_match._draw_points
    #                 - current_match._winning_points
    #                 )
    #             player_two_edited_score = (
    #                 current_match._draw_points
    #                 - current_match._losing_points
    #                 )
    #             print(f"draw : {current_match._draw_points} "
    #                   f"+ {current_match._winning_points} "
    #                   f"= {player_one_edited_score}"
    #                   )
    #             print(f"draw : {current_match._draw_points} "
    #                   f"+ {current_match._losing_points} "
    #                   f"= {player_two_edited_score}"
    #                   )

    #         elif (
    #             selected_value == MatchResult.DRAW
    #             and self.previous_result == MatchResult.LOSE
    #         ):
    #             player_one_edited_score = (
    #                 current_match._draw_points
    #                 - current_match._losing_points
    ...
    #         elif (
    #             selected_value == MatchResult.LOSE
    #             and self.previous_result == MatchResult.DRAW
    #         ):
    #             player_one_edited_score = (
    #                 current_match._losing_points
    #                 - current_match._draw_points
    ...
    #                 - current_match._draw_points
    #                 )
    #             print(f"draw : {current_match._losing_points} "
    #                   f"+ {current_match._draw_points} "
    #                   f"= {player_one_edited_score}"
    #                   )
    #             print(f"draw : {current_match._winning_points} "
    #                   f"+ {current_match._draw_points} "
    #                   f"= {player_two_edited_score}"
    #                   )
    ...
    #         elif (
    #             selected_value == MatchResult.WIN
    #             and self.previous_result == MatchResult.DRAW
    #         ):
    #             player_one_edited_score = (
    #                 current_match._winning_points
    ...
    #         self.tournament_controller.modify_matches_results(current_match,
    #                                                           player_one_edited_score,
    #                                                           player_two_edited_score
    #                                                           )
