...
class TournamentSimulatorView(QWidget):
    ...
    def populate_table(self):  
        for i in range(len(self.tournament.rounds), int(self.tournament.num_rounds)):
  
            current_round = int(i) if len(self.tournament.rounds) == int(self.tournament.num_rounds) else int(i) + 1
